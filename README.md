...
| 02 | [클러스터 생성](docs/02-create-cluster.md) | AKS + NAP + KEDA + Cilium |
| 03 | [빌드 & 푸시](docs/03-build-and-push.md) | Docker 빌드, ACR 푸시, 로컬 테스트 |
| 04 | [앱 배포](docs/04-deploy-app.md) | K8s 매니페스트 배포, 상태 확인 |
...
- **AKS**: NAP (Karpenter), KEDA, Azure CNI Overlay + Cilium
- **프론트엔드**: Vue.js 3.5 + Vite + Nginx
- **백엔드**: Rust, Node.js/Fastify, Go
- **인프라**: MongoDB, RabbitMQ
- **컨테이너**: Azure Container Registry (Basic)
- **리전**: Korea Central
